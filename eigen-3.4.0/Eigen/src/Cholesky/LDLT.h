 ...
 * \tparam _UpLo the triangular part that will be used for the decompositon:
...
public:
   ...
   * y_2 = y_1 \f$, \f$ D y_3 = y_2 \f$,
   * \f$ L^* y_4 = y_3 \f$ and \f$ P x = y_4 \f$ in succession. If the matrix
   * \f$ A \f$ is singular, then
   * \f$ D \f$ will also be singular (all the other matrices are invertible). In
   * that case, the least-square solution of \f$ D y_3 = y_2 \f$ is computed.
   * This does not mean that this function computes the least-square solution of
   * \f$ A x = b \f$ if \f$ A \f$ is singular.
   *
   ...
   * thus enabling generic code such as:
 ...
 * decomposition of A + sigma w w^T.
 * \param w a vector to be incorporated into the decomposition.
 * \param sigma a scalar, +1 for updates and -1 for "downdates," which
 * correspond to removing previously-added column vectors. Optional; default
 * value is +1.
 * \sa setZero()
 */
template <typename MatrixType, int _UpLo>
