...
template <typename Derived> struct EigenBase {
   ...
   * DEPRECATED: Since Eigen 3.3, its usage is deprecated. Use Eigen::Index
   * instead. Deprecation is not marked with a doxygen comment because there are
   * too many existing usages to add the deprecation attribute.
   */
