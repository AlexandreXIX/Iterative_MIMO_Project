 ...
 * examples of expression having one but note the other:
 *   \li writable expressions that don't have a very simple memory layout as a
 * strided array, have LvalueBit but not DirectAccessBit
 *   \li Map-to-const expressions, for example Map<const Matrix>, have
 * DirectAccessBit but not LvalueBit
 *
 ...
 * to the first element regardless of the expression kind:
 * \code
