...
/** \internal Returns the index of the first element of the array that is well
 * aligned with respect the largest packet requirement.
 * \sa first_aligned(Scalar*,Index) and
 * first_default_aligned(DenseBase<Derived>) */
 ...
 * allocation/deletion occurs. Here is an example:
 * \code
 * {
 ...
 * allocator: std::map< int, Vector3f > my_map_vec3;
 * \endcode
 *
