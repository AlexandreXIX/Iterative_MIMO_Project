 ...
 * each coefficient access in the bigger expression.
 ...
 * kind wrt to the functor. The default rules are as follows:
 * \code
 * A      op A      -> A
 * A      op dense  -> dense
 * dense  op B      -> dense
 ...
 * row/column/diagonal of a matrix type.
 * \tparam Scalar optional parameter allowing to pass a different scalar type
 * than the one of the MatrixType.
 */
