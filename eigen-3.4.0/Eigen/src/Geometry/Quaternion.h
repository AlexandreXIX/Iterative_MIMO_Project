...
public:
   ...
   * exactly equal.
   * \warning When using floating point scalar values you probably should rather
   * use a fuzzy comparison such as isApprox()
   ...
   * other are not exactly equal to each other.
   * \warning When using floating point scalar values you probably should rather
   * use a fuzzy comparison such as isApprox()
   * \sa isApprox(), operator== */
  template <class OtherDerived>
 ...
 * quaternions offer the following advantages:
