 ...
 * you need an invertibility check, do the following:
 ...
 * \param absDeterminantThreshold Optional parameter controlling the
 * invertibility check. The matrix will be declared invertible if the absolute
 * value of its determinant is greater than this threshold.
 *
