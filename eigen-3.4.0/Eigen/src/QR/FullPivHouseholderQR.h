 ...
 * matrices \b P, \b P', \b Q and \b R such that
 * \f[
 *  \mathbf{P} \, \mathbf{A} \, \mathbf{P}' = \mathbf{Q} \, \mathbf{R}
 * \f]
 * by using Householder transformations. Here, \b P and \b P' are permutation
 * matrices, \b Q a unitary matrix and \b R an upper triangular matrix.
 *
