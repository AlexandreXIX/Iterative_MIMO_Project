 ...
 * \f]
 * by using Householder transformations. Here, \b Q a unitary matrix and \b R an
 * upper triangular matrix. The result is stored in a compact way compatible
 * with LAPACK.
 *
...
public:
   ...
   * inplace decomposition \endlink when
